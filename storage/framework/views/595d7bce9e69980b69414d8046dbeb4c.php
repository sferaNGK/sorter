...
<script>
 const app1 = {
        ...
        methods:{
            ...
            async getGameCat(){
                let response_categCat = await fetch('<?php echo e(route('getGameCat')); ?>');
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vue\sorter\resources\views/game/game.blade.php ENDPATH**/ ?>